...
public class Throw : MonoBehaviour
{
    ...
    public void inputButton()
    {
        ...
        if (buttonName == "1")
        {
            ...
            Instantiate(spherePrefab, Camera.main.transform.position, Camera.main.transform.rotation);
        ...
        else if (buttonName == "3")
        {
            ...
            Instantiate(cubePrefab, Camera.main.transform.position, Camera.main.transform.rotation);
